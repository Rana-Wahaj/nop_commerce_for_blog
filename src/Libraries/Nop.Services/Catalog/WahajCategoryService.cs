...
public partial class WahajCategoryService : IWahajCategoryService
{
    #region Fields
    ...
    protected readonly IRepository<CategoryWahaj> _categoryRepository;
    protected readonly IRepository<DiscountCategoryMapping> _discountCategoryMappingRepository;
    protected readonly IRepository<Product> _productRepository;
    protected readonly IRepository<WahajProductCategory> _productCategoryRepository;
    ...
    public WahajCategoryService(
        IAclService aclService,
        ICustomerService customerService,
        ILocalizationService localizationService,
        IRepository<CategoryWahaj> categoryRepository,
        IRepository<DiscountCategoryMapping> discountCategoryMappingRepository,
        IRepository<Product> productRepository,
        IRepository<WahajProductCategory> productCategoryRepository,
    ...
    /// </returns>
    protected virtual async Task<IList<WahajProductCategory>> GetProductCategoriesByProductIdAsync(int productId, int storeId,
        bool showHidden = false)
    {
        if (productId == 0)
            return new List<WahajProductCategory>();
    ...
    /// </returns>
    protected virtual IEnumerable<CategoryWahaj> SortCategoriesForTree(
        ILookup<int, CategoryWahaj> categoriesByParentId,
        int parentId = 0,
    ...
    /// <returns>A task that represents the asynchronous operation</returns>
    public virtual async Task DeleteCategoryAsync (CategoryWahaj category)
    {
    ...
    /// <returns>A task that represents the asynchronous operation</returns>
    public virtual async Task DeleteCategoriesAsync(IList<CategoryWahaj> categories)
    {
    ...
    /// </returns>
    public virtual async Task<IList<CategoryWahaj>> GetAllCategoriesAsync(int storeId = 0, bool showHidden = false)
    {
    ...
    /// The task result contains the categories
    /// </returns>
    public virtual async Task<IPagedList<CategoryWahaj>> GetAllCategoriesAsync(string categoryName, int storeId = 0,
        int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false, bool? overridePublished = null)
    {
        ...
        //paging
        return new PagedList<CategoryWahaj>(sortedCategories, pageIndex, pageSize);
    }
    ...
    /// The task result contains the categories
    /// </returns>
    public virtual async Task<IList<CategoryWahaj>> GetAllCategoriesByParentCategoryIdAsync(int parentCategoryId,
        bool showHidden = false)
    {
    ...
    /// The task result contains the categories
    /// </returns>
    public virtual async Task<IList<CategoryWahaj>> GetAllCategoriesDisplayedOnHomepageAsync(bool showHidden = false)
    {
    ...
    /// </returns>
    public virtual async Task<CategoryWahaj> GetCategoryByIdAsync(int categoryId)
    {
    ...
    /// </returns>
    public virtual async Task<IPagedList<CategoryWahaj>> GetCategoriesByAppliedDiscountAsync(int? discountId = null,
    ...
    /// <param name="category">Category</param>
    /// <returns>A task that represents the asynchronous operation</returns>
    public virtual async Task InsertCategoryAsync (CategoryWahaj category)
    {
    ...
    /// <param name="category">Category</param>
    /// <returns>A task that represents the asynchronous operation</returns>
    public virtual async Task UpdateCategoryAsync (CategoryWahaj category)
    {
    ...
    /// <returns>A task that represents the asynchronous operation</returns>
    public virtual async Task DeleteProductCategoryAsync(WahajProductCategory productCategory)
    {
    ...
    /// </returns>
    public virtual async Task<IPagedList<WahajProductCategory>> GetProductCategoriesByCategoryIdAsync(int categoryId,
        int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false)
    {
        if (categoryId == 0)
            return new PagedList<WahajProductCategory>(new List<WahajProductCategory>(), pageIndex, pageSize);
    ...
    /// The task result contains the product category mapping collection
    /// </returns>
    public virtual async Task<IList<WahajProductCategory>> GetProductCategoriesByProductIdAsync(int productId, bool showHidden = false)
    {
        var store = await _storeContext.GetCurrentStoreAsync();
    ...
    /// </returns>
    public virtual async Task<WahajProductCategory> GetProductCategoryByIdAsync(int productCategoryId)
    {
    ...
    /// <returns>A task that represents the asynchronous operation</returns>
    public virtual async Task InsertProductCategoryAsync(WahajProductCategory productCategory)
    {
    ...
    /// <param name="productCategory">>Product category mapping</param>
    /// <returns>A task that represents the asynchronous operation</returns>
    public virtual async Task UpdateProductCategoryAsync(WahajProductCategory productCategory)
    {
    ...
    /// The task result contains the categories
    /// </returns>
    public virtual async Task<IList<CategoryWahaj>> GetCategoriesByIdsAsync(int[] categoryIds)
    {
    ...
    public virtual WahajProductCategory FindProductCategory(IList<WahajProductCategory> source, int productId, int categoryId)
    {
    ...
    /// </returns>
    public virtual async Task<string> GetFormattedBreadCrumbAsync (CategoryWahaj category, IList<CategoryWahaj> allCategories = null,
    ...
    /// </returns>
    public virtual async Task<IList<CategoryWahaj>> GetCategoryBreadCrumbAsync (CategoryWahaj category, IList<CategoryWahaj> allCategories = null, bool showHidden = false)
    {
        ArgumentNullException.ThrowIfNull(category);
        ...
        {
            var result = new List<CategoryWahaj>();
