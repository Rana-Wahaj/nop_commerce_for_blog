...
public partial class WahajCategoryController : BaseAdminController
{
    #region Fields

    protected readonly IAclService _aclService;
    protected readonly IWahajCategoryModelFactory _categoryModelFactory;
    protected readonly IWahajCategoryService _categoryService;
    ...
    public WahajCategoryController(IAclService aclService,
        IWahajCategoryModelFactory categoryModelFactory,
        IWahajCategoryService categoryService,
    ...
    protected virtual async Task UpdatePictureSeoNamesAsync(CategoryWahaj category)
    {
    ...
    public virtual async Task<IActionResult> Create(WahajCategoryModel model, bool continueEditing)
    {
        ...
        {
            var category = model.ToEntity<CategoryWahaj>();
    ...
    public virtual async Task<IActionResult> ProductAddPopup(AddProductToWahajCategoryModel model)
    {
        ...
        if (selectedProducts.Any())
        {
            ...
            foreach (var product in selectedProducts)
            {
                ...
                await _categoryService.InsertProductCategoryAsync(new WahajProductCategory
                {
