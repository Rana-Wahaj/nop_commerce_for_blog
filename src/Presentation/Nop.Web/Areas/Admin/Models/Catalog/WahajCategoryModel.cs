...
public partial record WahajCategoryModel : BaseNopEntityModel, IAclSupportedModel, IDiscountSupportedModel,
    ILocalizedModel<WahajCategoryLocalizedModel>, IStoreMappingSupportedModel
{
    #region Ctor

    public WahajCategoryModel()
    {
        if (PageSize < 1)
        {
            PageSize = 5;
        ...
        Locales = new List<WahajCategoryLocalizedModel>();
        ...
        CategoryProductSearchModel = new WahajCategoryProductSearchModel();
    }
    ...
    public IList<WahajCategoryLocalizedModel> Locales { get; set; }
    ...
    public WahajCategoryProductSearchModel CategoryProductSearchModel { get; set; }
...
public partial record WahajCategoryLocalizedModel : ILocalizedLocaleModel
{
